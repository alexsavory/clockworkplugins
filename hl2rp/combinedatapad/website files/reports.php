...
$result = mysql_query("SELECT * FROM  `combinereports` LIMIT 0 , 30");
?>
    <div class="container">
<?php
$perpage = 10;
...
if ($row['reviewed'] == "reviewed") {
  ...
  echo "<td><small>" . $row['unitname'] . "</small></td>";
  echo "<td><small>" . $row['dateooc'] . "</small></td>";
  echo "<td><small>" . $row['dateic'] . "</small></td>";
  echo "<td><small>" . $row['location'] . "</small></td>";
  if ($row['reviewed'] == "reviewed") {
