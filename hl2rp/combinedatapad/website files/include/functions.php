...
## A method to check wether the user is a 'high rank'
### we put the rank names in a array in the config, then check the sessions unit name in the array = ta-da its a high rank
